...
class BpRecordScreen extends StatefulWidget {
  const BpRecordScreen({Key? key}) : super(key: key);

  @override
  _BpRecordScreenState createState() => _BpRecordScreenState();
}

class _BpRecordScreenState extends State<BpRecordScreen> {
        ...
        child: ListView(
          children: [
            ...
            LabeledTextField(
              ...
              hintText: 'Enter here (between 20 to 300)',
