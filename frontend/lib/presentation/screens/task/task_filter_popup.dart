...
class TaskFilterPopup extends StatefulWidget {
  const TaskFilterPopup({Key? key}) : super(key: key);

  @override
  _FilterDialogState createState() => _FilterDialogState();
}

class _FilterDialogState extends State<TaskFilterPopup> {
  ...
  // Sample data for dropdowns
  final List<String> taskPriorityOptions = ['Low', 'Medium', 'High'];
  ...
  void _resetTaskCategory() {
    setState(() {
      selectedTaskCategory = null;
    });
  }

  void _resetTaskPriority() {
    setState(() {
      selectedTaskCategory = null;
    });
  }
  ...
  void _applyFilters() {
    Navigator.of(
      context,
    ).pop({'fromDate': fromDate, 'paymentStatus': selectedTaskCategory});
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDropdownSection(
                      ...
                      (value) => setState(() => selectedTaskCategory = value),
                      _resetTaskCategory,
                    ),
